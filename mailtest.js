...
console.log(senderEmail, appPass);
...
<html>
  ...
  <body style="font-family: Arial, sans-serif; margin: 0; padding: 20px">
    ...
    <div style="padding: 20px">
      Good morning [Name], We welcome you to join us for our ASD Adult Programs'
      ...
      <br />Emaleigh Sanchez | Administration <br />ASD Adult Achievement
...
const receiverEmail = "watkins.braedon@gmail.com";
const options = {
  from: `${senderEmail}`,
  to: `${receiverEmail}`,
